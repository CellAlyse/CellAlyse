...
def st_predict(img='images/Bild1.jpg', cell_type='rbc'):
    ...
    model.load_weights(f'storage/models/nn/{cell_type}.h5', skip_mismatch=True, by_name=True)
...
@st.experimental_memo
def hough_transform(img='edge.png', cell_type='rbc', minDist=33, maxRadius=55, minRadius=28, param1=30, param2=20):
    img = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
    if cell_type == 'rbc':
        circles = cv2.HoughCircles(img, cv2.HOUGH_GRADIENT, 1, minDist=minDist, maxRadius=maxRadius,
