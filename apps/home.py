...
def home():
    ...
    st.markdown("CellAlyse ist eine Webanwendung, die es ermöglicht, Blutausstriche auszuwerten."
                "Die Auswerung erfolgt mittels Machine Learning und Computer Vision.")

    st.markdown("## Was kann ich machen?")
    st.markdown("Generell gibt es zwei seperate KIs. Die eine kann weiße Blutzellen klassifizieren und zählen."
    ...
    st.markdown('Auf der linken Seite befinden sich die Module der Website.'
    ...
    st.markdown('Unter dem Modul "weiße Blutzellen" befindet sich das Zählungsmodul.'
